...
public class PhormSpecOfAttribute(string genProperty, object propertyValue) : Attribute
{
    /// <summary>
    /// The name of the property on the "Generalised" type definition to use when matching to a "Specialised" type.
    /// </summary>
    public string GenProperty { get; } = genProperty;
    /// <summary>
    /// The value of the "Generalised" type property to match with this "Specialised" type.
    /// </summary>
    public object PropertyValue { get; } = propertyValue ?? throw new ArgumentNullException(nameof(propertyValue));
}
